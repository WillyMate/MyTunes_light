...
public class SongCreate {public void showPopup() {
    try {
        // Indlæs FXML-filen
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/PopUpCreateSong.fxml"));
        Parent root = loader.load();

        // Opret en ny stage til popup
        Stage popupStage = new Stage();
        popupStage.initModality(Modality.APPLICATION_MODAL); // Gør det til en modal dialog
        popupStage.setTitle("Add/edit Song"); // Titel på popup
